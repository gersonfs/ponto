    ...
    <body>
        ...
        <table style="width: 80%">
            <tr>
                ...
                <?php
                $totalHit = $totalHEMenosHIC = $totalHTMes = $totalHNMes = $tSegundosNormais = $tSegundosTrabalhados = $sHE = $sHIC = $sH100 = $sHN = $sHi = 0;
                $totaisMeses = [];
                foreach ($dados as $i=>$dado) {
                    ...
                    if(isset($dado['is_fechamento'])) {
                        ...
                        $totalHit = $totalHEMenosHIC = $sH100 = $sHIC = $sHE = $tSegundosNormais = $totalHNMes = $totalHTMes = $tSegundosTrabalhados = $sHN = $sHi = 0;
                    }
                }
        ...
        <table>
            ...
            <?php 
            $somaHit = $somaNormal = $somaTrabalhada = $somaHe = $somaHic = $somaHeHic = $somaH50 = $somaH100 = $somaH130 = $somaHN = $somaHi = 0;
